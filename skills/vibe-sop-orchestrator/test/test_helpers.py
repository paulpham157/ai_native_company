#!/usr/bin/env python3
"""
test_helpers.py — Shared utilities cho vibe-sop-orchestrator tests.

Centralizes fixture loading, path resolution, and schema validation
so schema-validation.test.py and quick-mode.test.py don't duplicate logic.
"""
